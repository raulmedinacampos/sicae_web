<section id="lSolicitud">
	...
	<form id="formSolicitud" name="formSolicitud" method="post" action="<?php echo base_url('ponencia/nueva'); ?>">
		<div class="text-left">
			<a class="btn btn-primary" href="<?php echo base_url('ponencia/nueva'); ?>"><span class="glyphicon glyphicon-plus"></span> Solicitar nueva ponencia</a>
		</div>
		
		<h5>Ponencias solicitadas</h5>
		<hr class="red" />
		<table id="registros">
			<thead>
				<tr>
