		...
		<div role="tabpanel" class="tab-pane active" id="grado">
			<div class="row">
				<div class="form-group col-sm-12">
					...
					<input type="text" id="universidad" name="universidad" class="form-control" placeholder="Ingresa el nombre de la universidad" value="<?php if(isset($grado)) {echo $grado["ORGANIZA"];} ?>" />
					<input type="hidden" id="idSolicitud" name="idSolicitud" value="<?php if(isset($grado)) {echo $grado["ID"];} ?>" />
				</div>
			</div>
			<div class="row">
				<div class="form-group col-sm-4">
					...
					<select id="grado" name="grado" class="form-control">
						...
						<option <?php if ( isset($grado) && $grado["NOMBRE_EVENTO"] == "Maestría" ) {echo 'selected="selected"';} ?> value="Maestría">Maestría</option>
						<option <?php if ( isset($grado) && $grado["NOMBRE_EVENTO"] == "Doctorado" ) {echo 'selected="selected"';} ?> value="Doctorado">Doctorado</option>
					</select>
				</div>
				<div class="form-group col-sm-4">
