		...
		<div role="tabpanel" class="tab-pane active" id="evento">
			<div class="row">
				<div class="form-group col-sm-4">
					...
					<select id="tipoEvento" name="tipoEvento" class="form-control">
						...
						?>
						<option <?php if ( isset($seminario) && $seminario["TIPO_EVENTO_ID"] == $val->ID ) {echo 'selected="selected"';} ?> value="<?php echo $val->ID; ?>"><?php echo $val->DESCRIPCION; ?></option>
						<?php
						}
						?>
					</select>
				...
				<div class="form-group col-sm-4">
					...
					<input type="text" id="evento" name="evento" class="form-control" placeholder="Ingresa el nombre del evento" value="<?php if(isset($seminario)) {echo $seminario["NOMBRE_EVENTO"];} ?>" />
					<input type="hidden" id="idSolicitud" name="idSolicitud" value="<?php if(isset($seminario)) {echo $seminario["ID"];} ?>" />
				</div>
				<div class="form-group col-sm-4">
					<label>Sede<span class="form-text">*</span>:</label>
					<input type="text" id="sede" name="sede" class="form-control" placeholder="Ciudad, país" value="<?php if(isset($seminario)) {echo $seminario["SEDE"];} ?>" />
				</div>
			</div>
			<div class="row">
				<div class="form-group col-sm-12">
					<label>Institución que organiza<span class="form-text">*</span>:</label>
					<input type="text" id="institucion" name="institucion" class="form-control" placeholder="Ingresa la institución que organiza" value="<?php if(isset($seminario)) {echo $seminario["ORGANIZA"];} ?>" />
				</div>
			</div>
			<div class="row">
				<div class="form-group col-sm-4">
					<div class="datepicker-group">
						...
						<input type="text" id="fechaInicio" name="fechaInicio" class="datepicker form-control" data-mask="99/99/9999" placeholder="Fecha de inicio" value="<?php if(isset($seminario)) {echo $seminario["FECHA_INICIAL"];} ?>" />
				...
				<div class="form-group col-sm-4">
					<div class="datepicker-group">
						...
						<input type="text" id="fechaFin" name="fechaFin" class="datepicker form-control" data-mask="99/99/9999" placeholder="Fecha de término" value="<?php if(isset($seminario)) {echo $seminario["FECHA_FINAL"];} ?>" />
						<span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="form-group col-sm-8">
					...
					<input type="text" id="itinerario" name="itinerario" class="form-control" placeholder="Ingresa tu itinerario de viaje (origen - destino)" value="<?php if(isset($seminario)) {echo $seminario["ITINERARIO"];} ?>" />
				</div>
			</div>
						...
						<div class="panel-body">
							<div class="row">
								<div class="form-group col-sm-12">
									...
									<input type="text" id="justificacion" name="justificacion" class="form-control" placeholder="Llenar solo en caso de requerir dos o más días adicionales anteriores y/o posteriores al evento" value="<?php if(isset($seminario)) {echo $seminario["DA_JUSTIFICACION"];} ?>" />
								</div>
							</div>
							<div class="row">
								<div class="form-group col-sm-4">
									<div class="datepicker-group">
										...
										<input type="text" id="fechaSalida" name="fechaSalida" class="datepicker form-control" data-mask="99/99/9999" placeholder="Fecha de salida" value="<?php if(isset($seminario)) {echo $seminario["DA_FECHA_SALIDA"];} ?>" />
										<span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>
									</div>
								</div>
								<div class="form-group col-sm-4">
									<div class="datepicker-group">
										...
										<input type="text" id="fechaRegreso" name="fechaRegreso" class="datepicker form-control" data-mask="99/99/9999" placeholder="Fecha de regreso" value="<?php if(isset($seminario)) {echo $seminario["DA_FECHA_REGRESO"];} ?>" />
										<span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>
									</div>
								</div>
							</div>
